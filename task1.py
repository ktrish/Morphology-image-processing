...
cv2.imwrite('res_noise1.jpg',img_noise1)
...
cv2.imwrite('res_noise2.jpg',img_noise2)

##########Task 1.3##############
img_bound1=erosion(img_noise1,kernel)
img_bound1=img_noise1-img_bound1
cv2.imwrite('res_bound1.jpg',img_bound1)

img_bound2=erosion(img_noise2,kernel)
img_bound2=img_noise2-img_bound2
cv2.imwrite('res_bound2.jpg',img_bound2)
